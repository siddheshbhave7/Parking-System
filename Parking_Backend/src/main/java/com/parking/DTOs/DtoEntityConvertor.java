...
//		dto.setFare();
	...
	public SlotBookingDto fromBookingEntity(Booking book)
	{
		...
		entity.setParikingDuration(book.getParikingDuration());
		...
		entity.setBookingStatus(book.getBookingStatus());
		entity.setParkingName(book.getParking().getParkingName());
//		entity.setAmount(book);
		return entity; 
	}
